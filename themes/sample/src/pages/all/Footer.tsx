...
const VisaCard = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='38' height='24' aria-labelledby='pi-visa' viewBox='0 0 38 24'>
...
const MasterCard = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='38' height='24' aria-labelledby='pi-master' viewBox='0 0 38 24'>
      <path d='M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z' opacity='0.07'></path>
      <path fill='#fff' d='M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32'></path>
